...
class AdversarialRunner(object):
    ...
    def __init__(
        ...
        self.is_discrete_adversary_env_actions = is_discrete_actions(self.ued_venv, adversary=True)
        ...
        self.agent_rollout_steps = args.num_steps # ToDO
    ...
    def run(self):
        ...
        env_info = self.agent_rollout(
            ...
            update_level_sampler=False)
        # env_info is generated grid map
        # Run agent episodes
        level_sampler, is_updateable = self._get_level_sampler('agent')
        # what is level_sampler? 
        # rollout agent in where?
        ...
        if self.is_paired:
            ...
            # rollout adversary agent in where?
